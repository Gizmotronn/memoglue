...
/* Plan -> successful commands/references send a rocket animation up through the terminal
Successful returns will be presented by a rocket with a stickynote coming back down through the terminal, sliding to present the requested data
*/
